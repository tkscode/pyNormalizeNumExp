...
from pynormalizenumexp.expression import LimitedExpression, NNumber, NumberModifier, NormalizedExpression
...
class BaseNormalizer(object):
    ...
    def process(self, text: str) -> List[NormalizedExpression]:
        ...
        while i < len(expressions):
            normalized_id = self.normalize_limited_expression(replaced_text, expressions, i)
            if normalized_id == -1:
