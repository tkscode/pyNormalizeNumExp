...
from pynormalizenumexp.expression.base import INF, NTime
from pynormalizenumexp.normalize_numexp import Expression, NormalizeNumexp
    ...
    def test_normalize(self, normalize_numexp: NormalizeNumexp):
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(1911, INF, INF, INF, INF, INF),
                value_upper_bound=NTime(2011, -INF, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="duration", original_expr="100年間", position_start=17, position_end=22, counter="none",
                value_lower_bound=NTime(100, INF, INF, INF, INF, INF),
                value_upper_bound=NTime(100, -INF, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
        ...
        expect = [
            Expression(
                ...
                value_lower_bound_abs=NTime(INF), value_upper_bound_abs=NTime(-INF),
                value_lower_bound_rel=NTime(-15, INF, INF, INF, INF, INF),
                value_upper_bound_rel=NTime(-15, -INF, -INF, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
        ...
        expect = [
            Expression(
                ...
                value_lower_bound_abs=NTime(INF, 3, INF, INF, INF, INF),
                value_upper_bound_abs=NTime(-INF, 3, -INF, -INF, -INF, -INF),
                value_lower_bound_rel=NTime(-1, INF, INF, INF, INF, INF),
                value_upper_bound_rel=NTime(-1, -INF, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(INF, INF, INF, 15, 45, INF),
                value_upper_bound=NTime(-INF, -INF, -INF, 15, 45, -INF), options=[]
            )
        ]
        assert res == expect
    ...
    def test_normalize_day_of_week(self, normalize_numexp: NormalizeNumexp):
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(INF, 5, 3, INF, INF, INF),
                value_upper_bound=NTime(-INF, 5, 3, -INF, -INF, -INF), options=["Wed"]
            )
        ]
        assert res == expect
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(2001, 3, 3, INF, INF, INF),
                value_upper_bound=NTime(2001, 3, 3, -INF, -INF, -INF), options=["Sat"]
            )
        ]
        assert res == expect
    ...
    def test_normalize_real(self, normalize_numexp: NormalizeNumexp):
        ...
        expect = [
            Expression(
                ...
                value_lower_bound_abs=NTime(INF, INF, INF, INF, INF, INF),
                value_upper_bound_abs=NTime(-INF, -INF, -INF, -INF, -INF, -INF),
                value_lower_bound_rel=NTime(INF, INF, 0, INF, INF, INF),
                value_upper_bound_rel=NTime(-INF, -INF, 0, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="abstime", original_expr="4/26(Tue)まで", position_start=59, position_end=70, counter="none",
                value_lower_bound=NTime(INF, 4, 26, INF, INF, INF),
                value_upper_bound=NTime(-INF, 4, 26, -INF, -INF, -INF), options=["Tue"]
            )
        ]
        assert res == expect
    ...
    def test_normalize_inappropriate_range(self, normalize_numexp: NormalizeNumexp):
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(10000, INF, INF, INF, INF, INF),
                value_upper_bound=NTime(10000, -INF, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="reltime", original_expr="二千年前", position_start=4, position_end=8, counter="none",
                value_lower_bound_abs=NTime(INF), value_upper_bound_abs=NTime(-INF),
                value_lower_bound_rel=NTime(-2000, INF, INF, INF, INF, INF),
                value_upper_bound_rel=NTime(-2000, -INF, -INF, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
        ...
        expect = [
            Expression(
                ...
                value_lower_bound_abs=NTime(INF), value_upper_bound_abs=NTime(-INF),
                value_lower_bound_rel=NTime(-360000, INF, INF, INF, INF, INF),
                value_upper_bound_rel=NTime(-360000, -INF, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="reltime", original_expr="1万4000年前", position_start=23, position_end=31, counter="none",
                value_lower_bound_abs=NTime(INF), value_upper_bound_abs=NTime(-INF),
                value_lower_bound_rel=NTime(-14000, INF, INF, INF, INF, INF),
                value_upper_bound_rel=NTime(-14000, -INF, -INF, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
    ...
    def test_normalize_inappropriate_abstime(self, normalize_numexp: NormalizeNumexp):
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(198999, INF, INF, INF, INF, INF),
                value_upper_bound=NTime(198999, -INF, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="duration", original_expr="30月", position_start=7, position_end=10, counter="none",
                value_lower_bound=NTime(INF, 30, INF, INF, INF, INF),
                value_upper_bound=NTime(-INF, 30, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="duration", original_expr="41日", position_start=10, position_end=13, counter="none",
                value_lower_bound=NTime(INF, INF, 41, INF, INF, INF),
                value_upper_bound=NTime(-INF, -INF, 41, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(2009, 5, INF, INF, INF, INF),
                value_upper_bound=NTime(2009, 5, -INF, -INF, -INF, -INF), options=[]
            ),
            Expression(
                type="abstime", original_expr="99年5月", position_start=6, position_end=11, counter="none",
                value_lower_bound=NTime(1999, 5, INF, INF, INF, INF),
                value_upper_bound=NTime(1999, 5, -INF, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(99, 5, INF, INF, INF, INF),
                value_upper_bound=NTime(99, 5, -INF, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
    ...
    def test_normalize_range(self, normalize_numexp: NormalizeNumexp):
        ...
        expect = [
            Expression(
                ...
                value_lower_bound=NTime(2012, 4, 3, INF, INF, INF),
                value_upper_bound=NTime(2012, 4, 6, -INF, -INF, -INF), options=[]
            )
        ]
        assert res == expect
