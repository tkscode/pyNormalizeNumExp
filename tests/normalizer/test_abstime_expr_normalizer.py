...
class TestAbstimeExpressionNormalizer:
    ...
    def test_process(self, abstime_expr_normalizer: AbstimeExpressionNormalizer):
        ...
        expect[0].options = [""]
        expect[1].value_lower_bound = NTime(value=INF)
        expect[1].value_upper_bound = NTime(value=-INF)
        ...
        for number in numbers:
            ...
            e.value_lower_bound = NTime(value=INF)
            e.value_upper_bound = NTime(value=-INF)
